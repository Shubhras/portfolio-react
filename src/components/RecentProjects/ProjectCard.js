  ...
  return (<div>
    ...
    <div className="relative rounded-xl overflow-auto p-8"id="recent">
      <div className="grid grid-cols-2 gap-4 flex-wrap font-mono text-white text-sm text-center font-bold ml-52 mt-14" id="recent-project">
        <div className="p-4  w-8/12 h-96 bg-neutral-200 rounded-3xl shadow-lg mb-9 ml-14"id="card-1">
          <div className="-mt-5 -ml-4 -mr-4 bg-stone-800 h-60 rounded-ss-3xl rounded-tr-3xl">
            <h3 className="p-28 font-Montserrat text-xl"id="card-H-1">Design,Marketing</h3>
          </div>
          <div className="mt-8 text-left font-mono"id="card-P-1">
            <p className="text-black">ValueCheck</p>
            <a href="#" className="inline-block rounded-md border border-transparent bg-rose-500 px-8 py-3 text-center font-medium text-white hover:bg-rose-500 mt-8 font-mono"id="card-btn-1">
            View Project
            </a>
          </div>

        </div>
        <div className="p-4 w-8/12 h-96 bg-neutral-200 rounded-3xl shadow-lg -ml-20"id="card-2">

          <div className="-mt-5 -ml-4 -mr-4 bg-stone-800 h-60 rounded-ss-3xl rounded-tr-3xl">
            <h3 className="p-28 font-Montserrat text-xl"id="card-H-2">Design</h3>
          </div>
